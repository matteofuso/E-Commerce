...
header.innerHTML=`<div data-bs-theme="dark" class="bg-body shadow-lg sticky-top">
    ...
    <div class="d-flex justify-content-between align-items-center py-2 container">
        <a href="index.html" class="d-flex align-items-center text-decoration-none link-body-emphasis">
            <img src="images/logo.png" alt="La Libreria" class="logo" height="100px">
            <span class="logo-text h1 my-0 d-none d-sm-block ms-3">Aeternum</span>
        </a>
        <div class="d-flex">
